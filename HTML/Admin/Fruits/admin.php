...
if (isset($_POST['add_product'])) {
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `fruits`(`name`, `price`, `image`) VALUES('$p_name', '$p_price', '$p_image')") or die('query failed');
...
if(isset($_GET['delete'])){
   ...
   $delete_query = mysqli_query($conn, "DELETE FROM `fruits` WHERE id = $delete_id ") or die('query failed');
   if($delete_query){
...
if(isset($_POST['update_fruits'])){
   ...
   $update_query = mysqli_query($conn, "UPDATE `fruits` SET name = '$update_p_name', price = '$update_p_price', image = '$update_p_image' WHERE id = '$update_p_id'");
      ...
      <ul class="nav-links">
         ...
         <li>
            <a href="../fruits/admin.php">
               ...
               <span class="links_name"><h2>Fruits</h2></span>
            </a>
         </li>
         <li>
...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
   <h3>add a new product to Fruit</h3><br>
   ...
   <table>
      ...
      <tbody>
         <?php
            ...
            $select_fruits = mysqli_query($conn, "SELECT * FROM `fruits`");
...
<section class="edit-form-container">
   ...
   if(isset($_GET['edit'])){
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($conn, "SELECT * FROM `fruits` WHERE id = $edit_id");
