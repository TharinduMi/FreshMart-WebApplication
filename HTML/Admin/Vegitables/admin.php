...
if (isset($_POST['add_product'])) {
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `vegitables`(`name`, `price`, `image`) VALUES('$p_name', '$p_price', '$p_image')") or die('query failed');
...
if(isset($_GET['delete'])){
   ...
   $delete_query = mysqli_query($conn, "DELETE FROM `vegitables` WHERE id = $delete_id ") or die('query failed');
   if($delete_query){
...
if(isset($_POST['update_vegitables'])){
   ...
   $update_query = mysqli_query($conn, "UPDATE `vegitables` SET name = '$update_p_name', price = '$update_p_price', image = '$update_p_image' WHERE id = '$update_p_id'");
   ...
   <div class="sidebar">
      ...
      <ul class="nav-links">
         ...
         <li>
            <a href="#">
               <i class='bx bx-box'></i>
               <span class="links_name"><h2>Vegetables</h2></span>
            </a>
         </li>
         <li>
...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
   <h3>add a new product to Vegitables</h3><br>
   ...
   <table>
      ...
      <tbody>
         <?php
            ...
            $select_vegitables = mysqli_query($conn, "SELECT * FROM `vegitables`");
            if(mysqli_num_rows($select_vegitables) > 0){
               while($row = mysqli_fetch_assoc($select_vegitables)){
         ?>
...
<section class="edit-form-container">
   ...
   if(isset($_GET['edit'])){
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($conn, "SELECT * FROM `vegitables` WHERE id = $edit_id");
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="update the prodcut" name="update_vegitables" class="btn">
