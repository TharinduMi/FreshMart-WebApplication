...
<header>
   ...
   <h1 class="heading">Vegitables</h1>
  </center>
   <div class="card-container">
      <?php
      $select_products = mysqli_query($conn, "SELECT `name`, `price`, `image` FROM `vegitables`");
   ...
   <form action="" method="post">
      <div class="gallery">
         ...
         <img src="../Admin/vegitables/uploaded/<?php echo $fetch_product['image']; ?>" alt="">
